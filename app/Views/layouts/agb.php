...
<main class="app-main">
    <section class="app-section">
        ...
        <div class="agb-content">
            <p>1. Diese AGB gelten für alle Umzugs-, Transport- und damit verbundenen Dienstleistungen der Bären Crew.</p>
            <p>2. Sie gelten gegenüber Verbrauchern (§ 13 BGB) sowie Unternehmern (§ 14 BGB).</p>
            <p>3. Abweichende Bedingungen des Kunden werden nicht Vertragsbestandteil, es sei denn, Bären Crew stimmt ausdrücklich schriftlich zu.</p>
        </div>
    </div>
            <div class="agb-section">
        <button class="agb-toggle">§2 Vertragsschluss</button>
        <div class="agb-content">
            <p>1. Angebote sind freibleibend und unverbindlich, sofern nicht ausdrücklich als verbindlich bezeichnet.</p>
        ...
        <div class="agb-content">
            ...
            <p>2. Nicht ausdrücklich vereinbarte Zusatzleistungen (z. B. De-/Montagearbeiten, Verpackungsmaterial, Halteverbotszonen, Möbellift, Einlagerung) werden gesondert berechnet.</p>
            <p>3. Leistungsfristen sind nur verbindlich, wenn sie schriftlich zugesichert wurden.</p>
            <p>4. Unvorhersehbare Ereignisse (z. B. Witterung, Verkehr, behördliche Maßnahmen) verlängern die Leistungszeit angemessen.</p>
        </div>
    </div>
            <div class="agb-section">
        ...
        <div class="agb-content">
            ...
            <p>2. Besondere Güter (z. B. Wertgegenstände, empfindliche Geräte, Pflanzen, Tiere) müssen vorab ausdrücklich angegeben werden.</p>
        ...
        <div class="agb-content">
            ...
            <p>2. Zusatzleistungen oder Mehraufwand (z. B. längere Tragewege, Wartezeiten, nicht gemeldete Möbelstücke) werden gesondert berechnet.</p>
            <p>3. Rechnungen sind innerhalb von 7 Tagen ohne Abzug zahlbar, sofern nichts anderes vereinbart wurde.</p>
            <p>4. Bei Zahlungsverzug werden gesetzliche Verzugszinsen berechnet.</p>

            <h2>§6 Haftung und Haftungsbegrenzung</h2>
            <p>1. Die Haftung richtet sich nach den gesetzlichen Vorschriften des Handelsgesetzbuches (HGB), insbesondere §§ 451 ff. HGB.</p>
            <p>2. Die Haftung für Verlust oder Beschädigung des Umzugsgutes ist auf 620,00 € je Kubikmeter Laderaum beschränkt (§ 451e HGB).</p>
            <p>3. Für besonders wertvolle Gegenstände (z. B. Schmuck, Bargeld, Urkunden, Kunstgegenstände) wird keine Haftung übernommen, sofern diese nicht ausdrücklich schriftlich deklariert wurden.</p>
        ...
        <div class="agb-content">
            ...
            <p>2. Auf Wunsch kann eine zusätzliche Transportversicherung gegen Mehrpreis abgeschlossen werden.</p>
            <p>3. Ohne ausdrückliche Vereinbarung besteht kein Versicherungsschutz über die gesetzliche Haftungsgrenze hinaus.</p>
        </div>
    </div>
        ...
        <div class="agb-content">
            ...
            <p>3. Dem Kunden bleibt der Nachweis vorbehalten, dass kein oder ein geringerer Schaden entstanden ist.</p>
        ...
        <div class="agb-content">
            <p>Bei außerhalb von Geschäftsräumen oder im Fernabsatz geschlossenen Verträgen steht Verbrauchern ein gesetzliches Widerrufsrecht von 14 Tagen zu, sofern nicht bereits mit ausdrücklicher Zustimmung vor Ablauf der Widerrufsfrist mit der Leistung begonnen wurde.</p>
