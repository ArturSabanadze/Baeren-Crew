...
<main class="app-main">
    ...
    <p>
        ...
        Rechtsform: [Einzelunternehmen / GmbH / UG (haftungsbeschränkt)]<br>
    ...
    <h3>Registereintrag (falls zutreffend)</h3>
    <p>
    ...
    <h3>Zuständige Berufsgenossenschaft</h3>
    <p>
        Berufsgenossenschaft Verkehrswirtschaft Post-Logistik Telekommunikation (BG Verkehr)<br>
    ...
    <ul>
        <li>Betriebshaftpflichtversicherung: [Versicherer + Anschrift]</li>
        <li>Transportversicherung: [Versicherer + Anschrift]</li>
    </ul>
